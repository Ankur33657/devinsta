...
const UserSchema=mongoose.Schema({
    ...
    bio:{
        ...
        validate(value){
            if(value.length>50){
                throw new Error("Exceed 50 character");
            }
        },
        default:"Bio"
    },
